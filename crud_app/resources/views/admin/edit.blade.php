       ...
       <form action="{{ url('student_update', $student->id) }}" method="POST">
        ...
        @csrf
           <div class="mb-3">
               ...
               <input type="text" name="fullname" id="" class="form-control" value={{ $student->fullname }}>
               {{-- @error('firstname')
                   <p class="text-danger">
           ...
           <div class="mb-3">
               ...
               <input type="text" name="course" id="" class="form-control" value="{{ $student->course}}">
           </div>

           <div class="mb-3" style="margin:auto">
               <button type="submit" name="save_student" class="btn btn-primary">UPDATE</button>
           </div>
       </form>
